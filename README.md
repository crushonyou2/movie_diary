...
1.  **AI 감정 일기 분석:** 일기를 쓰면 AI가 핵심 감정(기쁨, 슬픔, 분노 등)을 분석하고 위로의 메시지를 건넵니다.
2.  **맞춤형 영화 추천 & OTT 필터:** 감정에 맞는 영화를 추천하되, 내가 구독 중인 OTT(넷플릭스, 왓챠 등)에 있는 작품만 골라볼 수 있습니다.
3.  **영화 다시 추천받기:** 추천된 영화가 마음에 들지 않다면? 버튼 하나로 새로운 영화 세트를 다시 제안받을 수 있습니다.
4.  **내 일기장 (History):** 작성한 일기와 추천받은 영화 기록이 저장되어, 언제든 다시 꺼내볼 수 있습니다.
5.  **영화 상세 정보:** 줄거리, 평점, 캐스팅 정보, 그리고 **지금 바로 볼 수 있는 OTT 링크**까지 제공합니다.
